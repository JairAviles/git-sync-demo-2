import {
  to = segment_tracking_plan.id-tp_3GY5UaORyMVLui2WTOU2eb9cOf6
  id = "tp_3GY5UaORyMVLui2WTOU2eb9cOf6"
}

resource "segment_tracking_plan" "id-tp_3GY5UaORyMVLui2WTOU2eb9cOf6" {
