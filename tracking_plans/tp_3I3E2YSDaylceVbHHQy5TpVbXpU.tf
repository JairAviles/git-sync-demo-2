import {
  to = segment_tracking_plan.id-tp_3I3E2YSDaylceVbHHQy5TpVbXpU
  id = "tp_3I3E2YSDaylceVbHHQy5TpVbXpU"
}

resource "segment_tracking_plan" "id-tp_3I3E2YSDaylceVbHHQy5TpVbXpU" {
